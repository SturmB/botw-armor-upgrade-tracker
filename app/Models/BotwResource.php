...
class BotwResource extends Model
{
    use HasFactory;
    ...
    {
        return $this->belongsToMany(BotwArmor::class, "botw_armor_resource")
    ...
    {
        return $this->hasMany(BotwRequirement::class, "botw_resource_id");
    }
}
