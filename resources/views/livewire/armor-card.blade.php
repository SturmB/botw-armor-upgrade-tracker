<li class="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg text-center shadow @if($isActive) bg-white @else bg-gray-200 @endif">
    @if($armor->upgradable)
        <input type="checkbox" class="absolute m-6 h-12 w-12 md:h-6 md:w-6 lg:h-10 lg:w-10 rounded border-gray-300 text-botw-blue-500 shadow-sm focus:border-botw-blue-300 focus:ring focus:ring-botw-blue-200 focus:ring-opacity-50" wire:model="isActive" wire:change="onChange" />
    @endif
