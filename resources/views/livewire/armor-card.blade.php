<li class="col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg text-center shadow @if($isActive) bg-white @else bg-gray-200 @endif">
    @if($armor->upgradable)
        <x-jet-checkbox class="absolute m-6 h-12 w-12 text-botw-blue-500 focus:border-botw-blue-300 focus:ring-botw-blue-200" wire:model="isActive" wire:change="onChange" />
    @endif
